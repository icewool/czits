...
uses
  ...
  UPGS in 'Main\UPGS.pas' {FramePGS: TFrame},
  ...
  uFrameMain in 'Main\uFrameMain.pas' {FrameMain: TFrame},
  ...
  uAddZHPTFunction in 'ZHPTGL\uAddZHPTFunction.pas' {FrameAddZHPTFunction: TFrame},
  ...
  uFrameZHPTDeviceRole in 'ZHPTGL\uFrameZHPTDeviceRole.pas' {FrameZHPTDeviceRole: TFrame},
  uFrameAddZHPTDevice in 'ZHPTGL\uFrameAddZHPTDevice.pas' {FrameAddZHPTDevice: TFrame},
  uFrameZHPTDeviceRoleEdit in 'ZHPTGL\uFrameZHPTDeviceRoleEdit.pas' {FrameZHPTDeviceRoleEdit: TFrame},
  uFrameZHPTDeviceRoleUser in 'ZHPTGL\uFrameZHPTDeviceRoleUser.pas' {FrameZHPTDeviceRoleUser: TFrame},
  uPicView in 'BaseFrame\uPicView.pas' {PicView: TFrame},
  uFrameZDTotal in 'SJTJFX\uFrameZDTotal.pas' {FrameZDTotal: TFrame},
  uCarFaceCompare in 'ZHXXCX\uCarFaceCompare.pas' {FrameCarFaceCompare: TFrame},
  uCarFaceGrid in 'ZHXXCX\uCarFaceGrid.pas' {FrameCarFaceGrid: TFrame},
  UFrameJJCSY in 'SJTJFX\UFrameJJCSY.pas' {FrameJJCSY: TFrame},
  UFrameSpot in 'SJTJFX\UFrameSpot.pas' {FrameSpot: TFrame},
  uSpotSearch in 'ZHXXCX\uSpotSearch.pas' {FrameSpotSearch: TFrame},
  UFrameLogStat in 'SJTJFX\UFrameLogStat.pas' {FrameLogStat: TFrame},
  uFrameVioCopy in 'JTWFGL\uFrameVioCopy.pas' {FrameVioCopy: TFrame},
  qjson in 'Common\qjson.pas',
  qrbtree in 'Common\qrbtree.pas',
  QString in 'Common\QString.pas',
  uFrameLogView in 'ZHPTGL\uFrameLogView.pas' {FrameLogView: TFrame},
  uFrameLogTotal in 'ZHPTGL\uFrameLogTotal.pas' {FrameLogTotal: TFrame},
  uFrameJTPCheck in 'DataAnalyse\uFrameJTPCheck.pas' {FrameJTPCheck: TFrame},
  uFrameJTPView in 'DataAnalyse\uFrameJTPView.pas' {FrameJTPLView: TFrame},
  uFrameJTPJob in 'DataAnalyse\uFrameJTPJob.pas' {FrameJTPJob: TFrame};
