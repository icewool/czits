...
type
  ...
  private
    ...
    procedure DoRminf(action: String; Params: TStrings;
      AResponseInfo: TIdHTTPResponseInfo; stream: TStream = nil);
...
procedure TRmService.DoRminf(action: String; Params: TStrings;
  AResponseInfo: TIdHTTPResponseInfo; stream: TStream);
var
  json: string;
  ss: TStringStream;
begin
  ...
  begin
    ...
    (stream as TMemoryStream).SaveToStream(ss);
    Params.Add(ss.DataString);
    ss.Free;
  end;
  json := ParamsToJson(Params);
...
begin
  ...
  begin
    ...
    begin
      DoRminf(action, Params, AResponseInfo, ARequestInfo.PostStream);
    end
